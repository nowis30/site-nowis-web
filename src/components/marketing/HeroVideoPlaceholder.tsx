          ...
          <div className="aspect-video w-full">
            <div className="flex h-full flex-col items-center justify-center px-4 text-center">
              ...
              <p className="mt-2 max-w-sm text-sm leading-6 text-[color:var(--site-muted)]">
                {hasVideo
                  ? 'Vidéo introuvable pour le moment. Dépose le fichier dans public/videos/publicite-video-creation-nowis-avec-simon-morin.mp4 ou définis une URL publique valide.'
