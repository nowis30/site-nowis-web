      ...
      {submitted ? (
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Ton avis a bien été envoyé. Je le lirai avec attention.
          </p>
        </div>
      ) : (
        <form
        ...
        >
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="message">
              Ton message (avis, retour, recommandation…)
            </label>
            <textarea
              id="message"
              name="message"
              ...
              required
              className="w-full rounded-xl border border-gray-200 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500"
              placeholder="Parle de ton expérience ou de ce que tu aimerais voir…"
            />
          </div>
