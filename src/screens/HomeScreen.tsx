...
export function HomeScreen() {
  return (
    <div className="mx-auto max-w-6xl px-6 pb-16 pt-12 text-slate-100 md:pt-16">
      <section className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 md:p-10">
      ...
      <section className="mt-10 rounded-3xl border border-primary-500/30 bg-primary-500/10 p-6 text-center md:p-10">
