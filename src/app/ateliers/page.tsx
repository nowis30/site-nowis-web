...
function workshopPriceLine() {
  return workshopPrices
    .map((item) => `${item.label} : ${formatPrice(item.regular)}`)
    .join(' · ');
}
...
const faqItems = [
  ...
  },
  {
    ...
    a: `Les ateliers suivent la grille officielle : ${workshopPriceLine()}. Pour certains groupes, une formule groupe peut etre offerte a partir de ${formatPrice(groupRegularPrice, ' / personne')}.`,
  },
  {
      ...
      <section className="relative overflow-hidden px-6 py-16 md:py-24">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 max-w-2xl text-base leading-8 text-[color:var(--site-muted)]">
            Une formule pensee pour les ecoles, les aines, les organismes et les groupes de Drummondville et partout au Quebec.
          </p>
