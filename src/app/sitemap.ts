...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = ['', '/musique', '/artistes', '/videos', '/a-propos', '/services', '/jeux', '/jeux/heritier-millionnaire', '/contact', '/creations', '/booking', '/logements', '/commander-une-chanson', '/assistant-projet', '/idees', '/avant-de-mecrire'];
