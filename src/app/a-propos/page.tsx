        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 grid gap-6 text-base leading-8 text-slate-300 lg:grid-cols-2">
            <div className="space-y-5">
              <p>
                Je m&apos;appelle Nowis Morin. Je suis artiste, musicien et passionné de création sous toutes ses formes. Mon univers, c&apos;est la musique — mais pas seulement. C&apos;est aussi l&apos;expression, la transmission, l&apos;idée que la création peut <strong className="text-white">vraiment toucher les gens</strong>.
              </p>
              <p>
                Ce qui m&apos;a amené à créer Création Nowis, c&apos;est un désir simple : rendre la création musicale <strong className="text-white">accessible, vivante et signifiante</strong> — pas juste pour les artistes professionals, mais pour chaque personne qui a quelque chose à exprimer ou à vivre collectivement.
              </p>
            </div>
            <div className="space-y-5">
              <p>
                J&apos;anime chaque atelier moi-même, en personne. Parce que la présence, l&apos;écoute et la connexion humaine font partie du résultat. Ce n&apos;est pas que de la technologie — c&apos;est <strong className="text-white">une expérience</strong>.
              </p>
              <p>
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div>
            ...
            <div className="mt-6 space-y-5 text-base leading-8 text-slate-300">
              <p>
                Je suis fasciné par l&apos;intelligence artificielle depuis que j&apos;ai commencé à y voir ce qu&apos;elle peut vraiment faire : <strong className="text-white">amplifier la créativité</strong> plutôt que la remplacer. L&apos;IA est un outil puissant. Mais c&apos;est toujours l&apos;humain qui décide de l&apos;intention, du ton, de l&apos;émotion et du résultat final.
              </p>
              <p>
                Dans mes ateliers, je ne montre pas l&apos;IA comme quelque chose d&apos;intimidant. Je la montre comme quelque chose qu&apos;on peut apprendre à utiliser — <strong className="text-white">ici, maintenant, concrètement</strong> — pour créer quelque chose de beau.
              </p>
              <p>
              ...
              <article
                ...
                className={`flex flex-col rounded-[2rem] border p-7 transition hover:-translate-y-1 ${
                  item.featured
                    ...
                    : 'border-white/10 bg-[rgba(10,14,26,0.6)]'
                }`}
              >
