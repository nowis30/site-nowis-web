...
export const contactInputSchema = z.object({
  ...
  billingLegalName: z.string().max(160).optional(),
  billingEmail: z.string().email('Email de facturation invalide').optional().or(z.literal('')),
  billingPhone: z.string().max(40).optional(),
  billingAddressLine1: z.string().max(240).optional(),
  billingAddressLine2: z.string().max(240).optional(),
